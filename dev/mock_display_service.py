...
def serve_assets(filename):
    # Possible base directories where files might live
    search_paths = [
        ASSETS_DIR / "assets", # Where Icons are
        ASSETS_DIR             # Where Fonts are
    ]
